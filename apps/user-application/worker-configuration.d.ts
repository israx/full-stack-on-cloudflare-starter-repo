/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env` (hash: f05de3059471bbc53e6c50032f326cc7)
// Runtime types generated with workerd@1.20260504.1 2025-07-11 
declare namespace Cloudflare {
	...
	interface ProdEnv {
		...
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
		BACKEND_SERVICE: Fetcher /* data-service-prod */;
	}
	interface Env {
		DB?: D1Database;
		ASSETS: Fetcher;
		...
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
		BACKEND_SERVICE?: Fetcher /* data-service-stage */ | Fetcher /* data-service-prod */;
	}
}
